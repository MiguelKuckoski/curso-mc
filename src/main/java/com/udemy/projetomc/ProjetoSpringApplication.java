...
public class ProjetoSpringApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36328912377", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "98389785"));

		Endereco e1 = new Endereco(null, "Rua flores", "300", "apro 303", "Jardim", "3822834", cli1, c1);
		...
		ItemPedido ip1 = new ItemPedido(ped1, p1, 1, 0.0, 2000.0);
		ItemPedido ip2 = new ItemPedido(ped1, p3, 2, 0.0,  80.0);
		ItemPedido ip3 = new ItemPedido(ped2, p2, 1, 100.0, 800.0);
